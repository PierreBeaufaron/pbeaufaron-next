                ...
                <div className="container">
                    <div className="header-inner d-flex align-items-center">
                        ...
                        <div className="logo-outer">
                            <div className="logo">
                                <Link href="/">
                                    <Image width={210} height={70} sizes='100vw' src={"/images/logo.png"} alt="Logo" title="Logo" />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="menu-btns">
                            <Link href="/contact" className="theme-btn">Contact Me <RiShakeHandsLine size={15} /> </Link>
                        </div>
                    </div>
                </div>
            </div>
